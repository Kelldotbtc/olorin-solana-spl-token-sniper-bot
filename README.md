...
- If you don't have winrar already installed you can download Olorin from Google Drive without needing to follow the rebuild from library files [Olorin_v1.0.0.0.zip]()
