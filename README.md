![image](https://github.com/Kelldotbtc/olorin-solana-spl-token-sniper-bot/assets/172572822/e73b7bb6-c36a-4a50-b555-da6ccaa5f666)
...
- NOTE: You **WILL** get an unknown publisher warning when running the bot for the first time. This is only because I haven't paid for a certificate yet although I may consider doing so once the project gains more users. For now you can bypass the message by clicking the more info link and then click the run anyway button. The warning will only pop up once when you initially launch the bot.
